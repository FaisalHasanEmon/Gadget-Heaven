...
import { getFromCard, getWishList, removeCardItem } from "../utilities";
...
const Dashboard = () => {
  ...
  useEffect(() => {
    const total = card_data.reduce((total, item) => total + item.price, 0);
    setTotalCost(total);
  }, []);
  ...
  return (
    <div className="font-sora">
      ...
      {/* Card Data Starts */}
      <div className={`${isCard ? "block" : "hidden"} container mx-auto`}>
        <div className="flex justify-between items-center font-bold text-xl">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-3 mt-5 font-bold text-xl">
            ...
            <button className="btn font-medium text-lg">Purchase</button>
          </div>
        </div>
        {/* card data */}
        <div>
